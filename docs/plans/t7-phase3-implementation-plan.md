# T7 — Phase-3 Implementation Plan (M1–M2 detailed · M3–M5 sketched)

> Companion to the **execution playbook** (`t7-execution-playbook.md`) and the **understanding doc**
> (`t7-goal-action-consistency-detector.md`). Built on the **§6 design decisions** (resolved 2026-05-31).
