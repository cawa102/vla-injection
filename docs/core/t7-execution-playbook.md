...
- **Last updated:** 2026-06-03 (granted GPU identified = **Kelvin2** NI-HPC@QUB → cluster docs `docs/gpu/` + **local-prep Task 11 GPU runbook DONE** `a491a63`/`9c3eaff`; see §10. Prior 2026-06-02: Codex review #2 across the plan + eval-harness held-out-FPR fix — see §10)
