---
name: project-map
description: Embodiment Evasion Tax VLA-security dissertation — directory layout, designated source-of-truth docs, key modules, and conventions for fast onboarding
metadata:
  type: project
---
