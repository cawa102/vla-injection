---
source_file: "docs/core/metric-a-annotation-schema.md"
type: "document"
community: "Metric (A) Frozen Schema"
tags:
  - graphify/document
  - graphify/EXTRACTED
  - community/Metric_A_Frozen_Schema
---

# metric-a-annotation-schema.md

## Connections
- [[Circularity guard  freeze-before-attack-inspection]] - `defined_in` [EXTRACTED]
- [[GoalResolver seam  PrivilegedGoalResolver]] - `defined_in` [EXTRACTED]
- [[Metric (A) Frozen Annotation Schema v1]] - `defined_in` [EXTRACTED]
- [[Monitoring ceiling (non-causal upper bound)]] - `defined_in` [EXTRACTED]
- [[P1 — progress  directional alignment primitive]] - `defined_in` [EXTRACTED]
- [[P2 — distractor engagement primitive]] - `defined_in` [EXTRACTED]
- [[P3 — grasp-event appropriateness primitive]] - `defined_in` [EXTRACTED]
- [[PrivilegedState contract (state.py)]] - `defined_in` [EXTRACTED]
- [[max combination rule (zero free parameters)]] - `defined_in` [EXTRACTED]
- [[srcevasion_taxmetricconsistency_a.py]] - `defined_in` [EXTRACTED]
- [[srcevasion_taxmetricstate.py]] - `defined_in` [EXTRACTED]

#graphify/document #graphify/EXTRACTED #community/Metric_A_Frozen_Schema

## 📄 Source

`docs/core/metric-a-annotation-schema.md`
