---
source_file: "tests/evasion_tax/eval/test_metrics.py"
type: "code"
...
## Connections
- [[A calib set with low benign scores and a disjoint held-out (eval) set     whos]] - `defined_in` [EXTRACTED]
- [[Benign rollouts (low max-score) vs attacked rollouts (high max-score).      Each]] - `defined_in` [EXTRACTED]
- [[OperatingPoint]] - `references` [EXTRACTED]
- [[Tests for eval statistics (Task 7) CIs, ROCAUC, TPR@FPR, summaries.  These are]] - `rationale_for` [EXTRACTED]
- [[_calib_low_eval_high()]] - `contains` [EXTRACTED]
- [[_separated_per_rollout()]] - `contains` [EXTRACTED]
- [[abort_rate()]] - `references` [EXTRACTED]
- [[benign_degradation()]] - `references` [EXTRACTED]
- [[calibrate()]] - `references` [EXTRACTED]
- [[detection_latency_summary()]] - `references` [EXTRACTED]
- [[proportion_ci()]] - `references` [EXTRACTED]
- [[roc_auc()]] - `references` [EXTRACTED]
- [[test_abort_rate_basic()]] - `contains` [EXTRACTED]
- [[test_abort_rate_rejects_count_above_total()]] - `contains` [EXTRACTED]
- [[test_abort_rate_rejects_negative_count()]] - `contains` [EXTRACTED]
- [[test_abort_rate_rejects_zero_total()]] - `contains` [EXTRACTED]
- [[test_auc_is_about_half_for_identical_distributions()]] - `contains` [EXTRACTED]
- [[test_auc_is_one_for_perfectly_separated_scores()]] - `contains` [EXTRACTED]
- [[test_benign_degradation_is_drop_in_success()]] - `contains` [EXTRACTED]
- [[test_benign_degradation_zero_when_unchanged()]] - `contains` [EXTRACTED]
- [[test_both_methods_contain_point_estimate()]] - `contains` [EXTRACTED]
- [[test_calib_fpr_diagnostic_stays_conservative_below_target()]] - `contains` [EXTRACTED]
- [[test_ci_width_shrinks_as_n_grows()]] - `contains` [EXTRACTED]
- [[test_ci_within_unit_interval()]] - `contains` [EXTRACTED]
- [[test_clopper_pearson_matches_known_reference_k8_n10()]] - `contains` [EXTRACTED]
- [[test_clopper_pearson_wider_than_wilson_at_small_n()]] - `contains` [EXTRACTED]
- [[test_detection_latency_summary_all_none()]] - `contains` [EXTRACTED]
- [[test_detection_latency_summary_filters_none()]] - `contains` [EXTRACTED]
- [[test_heldout_fpr_ci_uses_eval_n()]] - `contains` [EXTRACTED]
- [[test_k_equals_n_upper_bound_is_one()]] - `contains` [EXTRACTED]
- [[test_k_zero_lower_bound_is_zero()]] - `contains` [EXTRACTED]
- [[test_operating_point_cis_within_unit_interval()]] - `contains` [EXTRACTED]
- [[test_operating_point_records_split_sizes()]] - `contains` [EXTRACTED]
- [[test_proportion_ci_rejects_k_out_of_range()]] - `contains` [EXTRACTED]
- [[test_proportion_ci_rejects_nonpositive_n()]] - `contains` [EXTRACTED]
- [[test_proportion_ci_rejects_unknown_method()]] - `contains` [EXTRACTED]
- [[test_realised_benign_fpr_is_conservative_below_target()]] - `contains` [EXTRACTED]
- [[test_realised_fpr_falls_back_to_calib_when_no_eval_given()]] - `contains` [EXTRACTED]
- [[test_realised_fpr_is_measured_on_heldout_benign_eval()]] - `contains` [EXTRACTED]
- [[test_roc_curve_arrays_are_monotone_nondecreasing()]] - `contains` [EXTRACTED]
- [[test_tau_unchanged_by_benign_eval()]] - `contains` [EXTRACTED]
- [[test_tau_used_equals_calibrate_result()]] - `contains` [EXTRACTED]
- [[test_tpr_at_fpr_accepts_scalar_per_rollout_scores()]] - `contains` [EXTRACTED]
- [[test_tpr_at_fpr_does_not_mutate_input()]] - `contains` [EXTRACTED]
- [[test_tpr_at_fpr_returns_one_operating_point_per_target()]] - `contains` [EXTRACTED]
- [[test_tpr_high_when_classes_separate()]] - `contains` [EXTRACTED]
- [[test_wilson_matches_known_reference_k8_n10()]] - `contains` [EXTRACTED]
- [[tpr_at_fpr()]] - `references` [EXTRACTED]

#graphify/code #graphify/EXTRACTED #community/Detector_Metrics__CIs

## 📄 Source

`tests/evasion_tax/eval/test_metrics.py`
