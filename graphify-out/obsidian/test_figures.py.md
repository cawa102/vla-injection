---
source_file: "tests/evasion_tax/eval/test_figures.py"
type: "code"
community: "Figure Regeneration Tests"
location: "L1"
tags:
  - graphify/code
  - graphify/EXTRACTED
  - community/Figure_Regeneration_Tests
---

# test_figures.py

## Connections
- [[Tests for script-regenerable figures (Task 9).  ``make_figures`` is the M2 deliv]] - `rationale_for` [EXTRACTED]
- [[_synthetic_results()]] - `contains` [EXTRACTED]
- [[_write_results()]] - `contains` [EXTRACTED]
- [[make_figures()]] - `references` [EXTRACTED]
- [[results_table_to_dict()]] - `references` [EXTRACTED]
- [[run_condition_matrix()]] - `references` [EXTRACTED]
- [[test_make_figures_creates_missing_out_dir()]] - `contains` [EXTRACTED]
- [[test_make_figures_raises_when_results_missing()]] - `contains` [EXTRACTED]
- [[test_make_figures_returns_written_paths()]] - `contains` [EXTRACTED]
- [[test_make_figures_writes_expected_files()]] - `contains` [EXTRACTED]
- [[test_serialised_table_carries_power_block_flagging_underpowered_points()]] - `contains` [EXTRACTED]
- [[test_serialised_table_round_trips_into_make_figures()]] - `contains` [EXTRACTED]

#graphify/code #graphify/EXTRACTED #community/Figure_Regeneration_Tests

## 📄 Source

`tests/evasion_tax/eval/test_figures.py`
...
from evasion_tax.eval.harness import run_condition_matrix
