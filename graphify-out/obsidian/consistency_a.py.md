...
## Connections
- [[.__post_init__()_6]] - `defined_in` [EXTRACTED]
- [[._combine()]] - `defined_in` [EXTRACTED]
- [[._p1_progress()]] - `defined_in` [EXTRACTED]
- [[._p2_distractor()]] - `defined_in` [EXTRACTED]
- [[._p3_grasp()]] - `defined_in` [EXTRACTED]
- [[._semantics()]] - `defined_in` [EXTRACTED]
- [[._states()]] - `defined_in` [EXTRACTED]
- [[.extract_semantics()]] - `defined_in` [EXTRACTED]
- [[.resolve()]] - `defined_in` [EXTRACTED]
- [[.resolve()_1]] - `defined_in` [EXTRACTED]
- [[.score()]] - `defined_in` [EXTRACTED]
- [[.score_rollout()_2]] - `defined_in` [EXTRACTED]
- [[.score_rollout_monitoring_ceiling()]] - `defined_in` [EXTRACTED]
- [[Causal consistency score for ``step_index`` over ``a_{t-k+1t}``.          ``tru]] - `defined_in` [EXTRACTED]
- [[Causal goal-action consistency scorer over a prefix window (metric A).      Args]] - `defined_in` [EXTRACTED]
- [[Consistency metric (A) — frozen annotation schema + causal scorer (Task 5).  THE]] - `rationale_for` [EXTRACTED]
- [[ConsistencyMetricA]] - `contains` [EXTRACTED]
- [[ConsistencyMetricA (L2 oracle scorer)]] - `defined_in` [EXTRACTED]
- [[Frozen metric-(A) annotation schema (v1). No attack-tuned values.      Attribute]] - `defined_in` [EXTRACTED]
- [[GoalAnchor_1]] - `defined_in` [EXTRACTED]
- [[GoalAnchor]] - `contains` [EXTRACTED]
- [[GoalResolver]] - `contains` [EXTRACTED]
- [[GoalResolver (Protocol seam)]] - `defined_in` [EXTRACTED]
- [[NON-CAUSAL monitoring ceiling — a true upper bound on the causal score.]] - `defined_in` [EXTRACTED]
- [[One causal score per step (invariant 1).]] - `defined_in` [EXTRACTED]
- [[PrivilegedGoalResolver_1]] - `defined_in` [EXTRACTED]
- [[PrivilegedGoalResolver]] - `contains` [EXTRACTED]
- [[PrivilegedState]] - `defined_in` [EXTRACTED]
- [[Resolve the anchor from sim ground truth (privileged → non-deployable).      ``a]] - `defined_in` [EXTRACTED]
- [[Return the goal anchor, or ``None`` if it cannot be resolved.]] - `defined_in` [EXTRACTED]
- [[Rollout_6]] - `defined_in` [EXTRACTED]
- [[RolloutStep]] - `defined_in` [EXTRACTED]
- [[SchemaA]] - `contains` [EXTRACTED]
- [[SchemaA (frozen metric-A schema)]] - `defined_in` [EXTRACTED]
- [[Score_5]] - `defined_in` [EXTRACTED]
- [[Seam mapping a step (+ its privileged state) to a class`GoalAnchor`.      v1 s]] - `defined_in` [EXTRACTED]
- [[Semantics]] - `contains` [EXTRACTED]
- [[Semantics (3 inconsistency primitives)]] - `defined_in` [EXTRACTED]
- [[The frozen-schema parser, auditable in isolation (anti-circularity).]] - `defined_in` [EXTRACTED]
- [[The three extracted inconsistency primitives, each in ``0, 1``.]] - `defined_in` [EXTRACTED]
- [[The trusted goal resolved to a 3-D anchor + the goal object's name.]] - `defined_in` [EXTRACTED]
- [[_clip01()]] - `contains` [EXTRACTED]
...
`src/evasion_tax/metric/consistency_a.py`
