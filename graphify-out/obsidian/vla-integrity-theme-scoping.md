---
source_file: "docs/lit-review/vla-integrity-theme-scoping.md"
type: "document"
community: "Theme-Scoping Lit Review"
tags:
  - graphify/document
  - graphify/EXTRACTED
  - community/Theme-Scoping_Lit_Review
---

# vla-integrity-theme-scoping.md

## Connections
- [[EET candidate theme (instruction injection + consistency)]] - `defined_in` [EXTRACTED]
- [[Five VLA integrity threat channels]] - `defined_in` [EXTRACTED]
- [[T5 action-tokenization plausibility defense]] - `defined_in` [EXTRACTED]
- [[T9 persistent-backdoor supply-chain defense]] - `defined_in` [EXTRACTED]
- [[Trusted-intent channel load-bearing assumption]] - `defined_in` [EXTRACTED]
- [[VLA integrity theme-scoping literature review]] - `defined_in` [EXTRACTED]

#graphify/document #graphify/EXTRACTED #community/Theme-Scoping_Lit_Review

## 📄 Source

`docs/lit-review/vla-integrity-theme-scoping.md`
