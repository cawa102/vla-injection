---
source_file: "tests/evasion_tax/metric/test_probe_confounds.py"
type: "code"
...
# test_probe_confounds.py

## Connections
- [[InternalProbe_1]] - `references` [EXTRACTED]
- [[SyntheticActivationExtractor]] - `references` [EXTRACTED]
- [[Tests for the L1 confound-control scaffolding (Codex review 2 11).  Pre-regist]] - `rationale_for` [EXTRACTED]
- [[labeled_features()]] - `shares_data_with` [EXTRACTED]
- [[probe_auc()]] - `references` [EXTRACTED]
- [[shuffle_labels()]] - `references` [EXTRACTED]
- [[test_label_shuffle_control_collapses_probe_to_chance()]] - `contains` [EXTRACTED]
- [[test_probe_auc_is_high_for_a_separable_probe()]] - `contains` [EXTRACTED]
- [[test_probe_auc_rejects_length_mismatch()]] - `contains` [EXTRACTED]
- [[test_probe_auc_rejects_single_class_labels()]] - `contains` [EXTRACTED]
- [[test_probe_internal.py]] - `imports_from` [EXTRACTED]
- [[test_shuffle_labels_changes_order_and_varies_with_seed()]] - `contains` [EXTRACTED]
- [[test_shuffle_labels_does_not_mutate_input()]] - `contains` [EXTRACTED]
- [[test_shuffle_labels_preserves_multiset_and_is_deterministic()]] - `contains` [EXTRACTED]

#graphify/code #graphify/EXTRACTED #community/L1_Internal_Probe

## 📄 Source

`tests/evasion_tax/metric/test_probe_confounds.py`
