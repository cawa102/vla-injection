---
source_file: "tests/evasion_tax/repro/test_provenance.py"
type: "code"
...
## Connections
- [[Tests for the SHA-256 helper and the JSON provenance manifest.]] - `rationale_for` [EXTRACTED]
- [[record_provenance()]] - `references` [EXTRACTED]
- [[sha256_file()]] - `references` [EXTRACTED]
- [[test_openvla_stats.py]] - `semantically_similar_to` [INFERRED]
- [[test_record_provenance_appends_distinct_names()]] - `contains` [EXTRACTED]
- [[test_record_provenance_creates_manifest_and_round_trips()]] - `contains` [EXTRACTED]
- [[test_record_provenance_updating_same_name_replaces_only_that_entry()]] - `contains` [EXTRACTED]
- [[test_sha256_file_empty_file()]] - `contains` [EXTRACTED]
- [[test_sha256_file_matches_known_hash()]] - `contains` [EXTRACTED]
- [[test_sha256_file_missing_path_raises()]] - `contains` [EXTRACTED]

#graphify/code #graphify/EXTRACTED #community/Stats_Provenance

## 📄 Source

`tests/evasion_tax/repro/test_provenance.py`
...
from evasion_tax.repro import record_provenance, sha256_file
