---
source_file: "src/evasion_tax/eval/figures.py"
type: "code"
...
## Connections
- [[Path]] - `defined_in` [EXTRACTED]
- [[Regenerate all M2 figures from a logged ``results.json``.      Args         res]] - `defined_in` [EXTRACTED]
- [[ResultsTable]] - `defined_in` [EXTRACTED]
- [[Script-regenerable figures from logged results (Task 9, M2 deliverable).  Every]] - `rationale_for` [EXTRACTED]
- [[Serialise a class`ResultsTable` to the ``results.json`` schema.      Merges ea]] - `defined_in` [EXTRACTED]
- [[StrPath_1]] - `defined_in` [EXTRACTED]
- [[_ladder_placeholder_figure()]] - `contains` [EXTRACTED]
- [[_load_results]] - `defined_in` [EXTRACTED]
- [[_load_results()]] - `contains` [EXTRACTED]
- [[_roc_figure]] - `defined_in` [EXTRACTED]
- [[_roc_figure()]] - `contains` [EXTRACTED]
- [[_score_hist_figure()]] - `contains` [EXTRACTED]
- [[_tpr_at_fpr_figure]] - `defined_in` [EXTRACTED]
- [[_tpr_at_fpr_figure()]] - `contains` [EXTRACTED]
- [[make_figures]] - `defined_in` [EXTRACTED]
- [[make_figures()]] - `contains` [EXTRACTED]
- [[results_table_to_dict]] - `defined_in` [EXTRACTED]
- [[results_table_to_dict()]] - `contains` [EXTRACTED]

#graphify/code #graphify/EXTRACTED #community/Figure_Generation

## 📄 Source

`src/evasion_tax/eval/figures.py`
