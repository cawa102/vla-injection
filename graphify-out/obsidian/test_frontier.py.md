---
source_file: "tests/evasion_tax/attack/test_frontier.py"
type: "code"
community: "Pareto Frontier & ASR"
location: "L1"
tags:
  - graphify/code
  - graphify/EXTRACTED
  - community/Pareto_Frontier__ASR
---

# test_frontier.py

## Connections
- [[Frontier]] - `references` [EXTRACTED]
- [[FrontierPoint]] - `references` [EXTRACTED]
- [[Tests for the (ASR, evasion) Pareto-frontier geometry (playbook §4b-(II)).  Pure]] - `rationale_for` [EXTRACTED]
- [[asr_at_evasion()]] - `references` [EXTRACTED]
- [[pareto_frontier()]] - `references` [EXTRACTED]
- [[pt()]] - `contains` [EXTRACTED]
- [[test_asr_at_evasion_clamps_above_max_evasion_to_min_asr()]] - `contains` [EXTRACTED]
- [[test_asr_at_evasion_clamps_below_min_evasion_to_max_asr()]] - `contains` [EXTRACTED]
- [[test_asr_at_evasion_interpolates_between_points()]] - `contains` [EXTRACTED]
- [[test_asr_at_evasion_is_monotone_non_increasing()]] - `contains` [EXTRACTED]
- [[test_asr_at_evasion_on_empty_frontier_raises()]] - `contains` [EXTRACTED]
- [[test_asr_at_evasion_returns_exact_point()]] - `contains` [EXTRACTED]
- [[test_frontier_accepts_canonical_shape()]] - `contains` [EXTRACTED]
- [[test_frontier_accepts_empty_and_single()]] - `contains` [EXTRACTED]
- [[test_frontier_is_immutable()]] - `contains` [EXTRACTED]
- [[test_frontier_point_is_immutable()]] - `contains` [EXTRACTED]
- [[test_frontier_point_rejects_negative_tradeoff()]] - `contains` [EXTRACTED]
- [[test_frontier_point_rejects_out_of_range_asr()]] - `contains` [EXTRACTED]
- [[test_frontier_point_rejects_out_of_range_evasion()]] - `contains` [EXTRACTED]
- [[test_frontier_rejects_non_monotone_points()]] - `contains` [EXTRACTED]
- [[test_pareto_collapses_exact_duplicates_keeping_min_tradeoff()]] - `contains` [EXTRACTED]
- [[test_pareto_drops_dominated_points()]] - `contains` [EXTRACTED]
- [[test_pareto_keeps_only_the_dominating_point()]] - `contains` [EXTRACTED]
- [[test_pareto_of_empty_is_empty()]] - `contains` [EXTRACTED]
- [[test_pareto_of_single_point_is_that_point()]] - `contains` [EXTRACTED]
- [[test_pareto_returns_points_ordered_by_evasion_ascending()]] - `contains` [EXTRACTED]

#graphify/code #graphify/EXTRACTED #community/Pareto_Frontier__ASR

## 📄 Source

`tests/evasion_tax/attack/test_frontier.py`
