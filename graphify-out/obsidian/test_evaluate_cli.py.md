---
source_file: "tests/evasion_tax/eval/test_evaluate_cli.py"
type: "code"
...
## Connections
- [[A minimal valid run config with controllable split overlap.]] - `defined_in` [EXTRACTED]
- [[CompletedProcess]] - `defined_in` [EXTRACTED]
- [[End-to-end CLI tests for ``scriptsevaluate.py`` (wiring, invariant 3).  Runs t]] - `rationale_for` [EXTRACTED]
- [[Path_3]] - `defined_in` [EXTRACTED]
- [[_config()]] - `contains` [EXTRACTED]
- [[_run()]] - `contains` [EXTRACTED]
- [[evaluate.py]] - `references` [EXTRACTED]
- [[test_evaluate_aborts_on_overlapping_splits()]] - `contains` [EXTRACTED]
- [[test_evaluate_runs_on_disjoint_splits()]] - `contains` [EXTRACTED]

#graphify/code #graphify/EXTRACTED #community/Calib/Test_Split_Disjointness

## 📄 Source

`tests/evasion_tax/eval/test_evaluate_cli.py`
