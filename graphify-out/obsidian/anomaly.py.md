...
## Connections
- [[.__post_init__()_5]] - `defined_in` [EXTRACTED]
- [[.as_arrays()]] - `defined_in` [EXTRACTED]
- [[.from_rollouts()]] - `defined_in` [EXTRACTED]
- [[BenignActionStats]] - `contains` [EXTRACTED]
- [[Estimate per-dim meanstd from the pooled actions of benign rollouts.          A]] - `defined_in` [EXTRACTED]
- [[Goal-agnostic action-anomaly baseline (Task 8).  The mandatory M2 comparison]] - `rationale_for` [EXTRACTED]
- [[One causal, goal-agnostic anomaly score per step (higher = more anomalous).]] - `defined_in` [EXTRACTED]
- [[Per-dimension benign action statistics (immutable; plan invariant 6).      Stor]] - `defined_in` [EXTRACTED]
- [[Return ``(mean, std)`` as float ndarrays.]] - `defined_in` [EXTRACTED]
- [[Rollout_4]] - `defined_in` [EXTRACTED]
- [[Score_2]] - `defined_in` [EXTRACTED]
- [[goal_agnostic_anomaly_score()]] - `contains` [EXTRACTED]
- [[ndarray_3]] - `defined_in` [EXTRACTED]
...
`src/evasion_tax/baselines/anomaly.py`
...
from evasion_tax.records import ACTION_DIM, Rollout, Score
