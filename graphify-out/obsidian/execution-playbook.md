---
source_file: "docs/core/execution-playbook.md"
type: "document"
community: "L1 Probe Literature"
tags:
  - graphify/document
  - graphify/EXTRACTED
  - community/L1_Probe_Literature
---

# execution-playbook.md

## Connections
- [[Causal prefix-window detection + detection latency]] - `defined_in` [EXTRACTED]
- [[Claim boundary  no-over-claim guardrail (Codex review 2)]] - `defined_in` [EXTRACTED]
- [[Compute Branch F (oracle frontier only)]] - `defined_in` [EXTRACTED]
- [[Compute Branch N (full deployable tax)]] - `defined_in` [EXTRACTED]
- [[Compute Branch N− (scoped deployable tax)]] - `defined_in` [EXTRACTED]
- [[Concept-Dictionary VLA safety (arXiv2602.01834)]] - `defined_in` [EXTRACTED]
- [[Coverage manifest (Codex 6; coverage.py)]] - `defined_in` [EXTRACTED]
- [[Cross-layer evaluation + tax metrics (evalcross_layer.py)]] - `defined_in` [EXTRACTED]
- [[D4 — eval scale  matrix decision (OPEN→M1)]] - `defined_in` [EXTRACTED]
- [[D7 — compute budget  GCG micro-bench (OPEN→M1)]] - `defined_in` [EXTRACTED]
- [[D8 — compute (A100H100 Kelvin2; branch selection)]] - `defined_in` [EXTRACTED]
- [[Embodiment Evasion Tax Execution Playbook]] - `defined_in` [EXTRACTED]
- [[Embodiment Evasion Tax measurement reframe (§3a)]] - `defined_in` [EXTRACTED]
- [[FP calibration (held-out per-rollout false-abort)]] - `defined_in` [EXTRACTED]
- [[H1 — benign-vs-attacked separability (M1 gate)]] - `defined_in` [EXTRACTED]
- [[H2 — usable calibrated operating point (floor)]] - `defined_in` [EXTRACTED]
- [[H3 — graceful degradation across reference ladder]] - `defined_in` [EXTRACTED]
- [[H4 — deployable metric recovers (A) ceiling power]] - `defined_in` [EXTRACTED]
- [[H5 — adaptive attacker raises the attacker's bar]] - `defined_in` [EXTRACTED]
- [[H6-A — oracle intrinsic action-space frontier (floor)]] - `defined_in` [EXTRACTED]
- [[H6-D — deployable-vs-deployable cross-layer tax (headline)]] - `defined_in` [EXTRACTED]
- [[IGAR attention recalibration (arXiv2603.06001)]] - `defined_in` [EXTRACTED]
- [[Idealized action-space attacker instrument (idealized_frontier.py)]] - `defined_in` [EXTRACTED]
- [[L0 input layer (perplexity  text-only filter)]] - `defined_in` [EXTRACTED]
- [[L1 confound controls (Codex 11)]] - `defined_in` [EXTRACTED]
- [[L1 internal probe instrument (probe_internal.py)]] - `defined_in` [EXTRACTED]
- [[L1 internal-representation probe layer]] - `defined_in` [EXTRACTED]
- [[L2 behavioural action-monitor layer]] - `defined_in` [EXTRACTED]
- [[LIBERO simulation benchmark]] - `defined_in` [EXTRACTED]
- [[M0 — Design lock]] - `defined_in` [EXTRACTED]
- [[M1 on-GPU timing micro-bench (branch selector)]] - `defined_in` [EXTRACTED]
- [[M1 — Environment + viability gate + compute confirmation]] - `defined_in` [EXTRACTED]
- [[M2 — Floor detection layer (L0 + L2-oracle calibrated)]] - `defined_in` [EXTRACTED]
- [[M3 — Oracle intrinsic action-space frontier (H6-A)]] - `defined_in` [EXTRACTED]
- [[M4 — Deployable L2 + H6-D cross-layer tax]] - `defined_in` [EXTRACTED]
- [[M5 — Reference-coarsening ladder + threat-generalization]] - `defined_in` [EXTRACTED]
- [[Mechanism M-a — GCG-can't-differentiate-through-rollout artifact]] - `defined_in` [EXTRACTED]
- [[Mechanism M-b — idealized action-space attacker (intrinsic tax)]] - `defined_in` [EXTRACTED]
- [[Metric (A) — privileged sim-state consistency metric (L2 oracle)]] - `defined_in` [EXTRACTED]
- [[Metric (B) — learned action-semantics map (deployable L2)]] - `defined_in` [EXTRACTED]
- [[Metric (C) — reference-policy divergence (deployable L2 alt)]] - `defined_in` [EXTRACTED]
- [[Metric (D) — VLMLLM judge (excluded)]] - `defined_in` [EXTRACTED]
- [[OpenVLA-7B (base VLA, bf16, discrete 256-bin head)]] - `defined_in` [EXTRACTED]
- [[Operating-point power  sample-size rule (Codex 3; power.py)]] - `defined_in` [EXTRACTED]
- [[Oracle-bound direction (upper-bounds deployable  lower-bounds realistic)]] - `defined_in` [EXTRACTED]
- [[RoboGCG attack (arXiv2506.03350)]] - `defined_in` [EXTRACTED]
- [[Target-action-blocked rate (security metric, invariant 9)]] - `defined_in` [EXTRACTED]
- [[The Attacker Moves Second (Nasr et al., arXiv2510.09023)]] - `defined_in` [EXTRACTED]
- [[srcevasion_taxattackdynamics.py]] - `defined_in` [EXTRACTED]
- [[srcevasion_taxattackfrontier.py]] - `defined_in` [EXTRACTED]
- [[srcevasion_taxattackidealized_frontier.py]] - `defined_in` [EXTRACTED]
- [[srcevasion_taxevalcross_layer.py]] - `defined_in` [EXTRACTED]
- [[srcevasion_taxevalpower.py]] - `defined_in` [EXTRACTED]
- [[srcevasion_taxmetriccoverage.py]] - `defined_in` [EXTRACTED]
- [[srcevasion_taxmetricprobe_internal.py]] - `defined_in` [EXTRACTED]
- [[ΔASR-at-fixed-evasion primary tax scalar (Codex 10)]] - `defined_in` [EXTRACTED]

#graphify/document #graphify/EXTRACTED #community/L1_Probe_Literature

## 📄 Source

`docs/core/execution-playbook.md`
...
- **▶ NEXT ACTION:** **Local (now):** the model-free §4b interfaces + Codex-#2 hooks are **DONE** (L1 probe + confound scaffolding `fadc008`; idealized attacker `ac4f229`; cross-layer eval + ΔASR tax scalar #10, coverage manifest #6, power rule #3 — 2026-06-03). **Task 11 GPU runbook also DONE** (`docs/setup/gpu-runbook.md`, Kelvin2). **Local-prep is now fully complete (Tasks 0–11)** — Task 10 done (`577c2d1`): Tier R/robosuite validated the `PrivilegedState` contract, real LIBERO deferred to the GPU node. **The only remaining gate is GPU access (Kelvin2 login not yet established).** **On the granted GPU (Kelvin2 `k2-gpu-a100`/`k2-gpu-h100`, M1) — follow `docs/setup/gpu-runbook.md`:** stand up OpenVLA-7B on the *actual* HW; benign baseline + RoboGCG *targeted* redirect; **GCG micro-bench on that HW (fixes D4/D7)**; metric-(A) signal incl. coarse-goal check; **run the on-GPU timing micro-bench → select compute Branch N/N−/F (D8)** → **GO/NO-GO gate (H1)**.
- **Blockers:** none.
...
**Compute branches (2026-06-02, D8 — selected at M1).** Hardware is **A100/H100** = **Kelvin2** (NI-HPC@QUB;
partitions `k2-gpu-a100`/`k2-gpu-h100`, **3-day walltime cap**, shared/queued — `docs/gpu/`, runbook
`docs/setup/gpu-runbook.md`); OpenVLA-7B runs in **bf16**. There is no longer a binary "does the cluster exist?"
...
| **D8** | Compute | **A100/H100 granted 2026-06-02; identified 2026-06-03 = Kelvin2** (NI-HPC@QUB) — partitions `k2-gpu-a100` (4 nodes × 4×A100-80GB) / `k2-gpu-h100` (1 node × 4×H100-80GB), **3-day walltime cap**, **shared → queue depth TBC** (`docs/gpu/Overview.md`); OpenVLA-7B in **bf16** (~14 GB, fits one 80 GB card). The **M1 on-GPU timing micro-bench** computes the affordable matrix → selects **Branch N** (full deployable tax) / **N−** (scoped) / **F** (oracle frontier only) — see §2 *Compute branches*; runbook = `docs/setup/gpu-runbook.md`. **Log exact HW (A100 vs H100) + precision + parallelism per run; no cross-HW comparison within a claim.** | **OPEN** → M1 (branch selection) |
...
- ✅ Write Phase-3 implementation plan (`docs/plans/phase3-implementation-plan.md`) **+ revise per Codex review**. `verify:` author OKs before coding.
