---
source_file: "scripts/demo_metric_separation.py"
type: "code"
community: "Metric Separation Demo"
location: "L1"
tags:
  - graphify/code
  - graphify/EXTRACTED
  - community/Metric_Separation_Demo
---

# demo_metric_separation.py

## Connections
- [[A tiny text histogram of scores over 0, 1 for the printed report.]] - `defined_in` [EXTRACTED]
- [[Any]] - `defined_in` [EXTRACTED]
- [[Generate ``n`` benign + ``n`` attacked rollouts and score each with metric (A).]] - `defined_in` [EXTRACTED]
- [[Generate ``n`` benign + ``n`` attacked rollouts via the chosen backend.      Rol]] - `defined_in` [EXTRACTED]
- [[Per-rollout score = max per-step inconsistency (matches the eval convention).]] - `defined_in` [EXTRACTED]
- [[Rollout]] - `defined_in` [EXTRACTED]
- [[Score]] - `defined_in` [EXTRACTED]
- [[_generate()]] - `contains` [EXTRACTED]
- [[_histogram()]] - `contains` [EXTRACTED]
- [[_max_score()]] - `contains` [EXTRACTED]
- [[_print_report()]] - `contains` [EXTRACTED]
- [[demo_metric_separation._generate]] - `defined_in` [EXTRACTED]
- [[generate_scored()]] - `contains` [EXTRACTED]
- [[main()_2]] - `contains` [EXTRACTED]
- [[records.py]] - `imports_from` [EXTRACTED]

#graphify/code #graphify/EXTRACTED #community/Metric_Separation_Demo

## 📄 Source

`scripts/demo_metric_separation.py`
