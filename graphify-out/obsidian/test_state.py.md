---
source_file: "tests/evasion_tax/metric/test_state.py"
type: "code"
...
- [[Tests for the privileged-state adapter + synthetic fixtures (Task 4).]] - `rationale_for` [EXTRACTED]
- [[fixtures_state.py]] - `references` [EXTRACTED]
- [[test_adapter_builds_well_formed_state_from_each_fixture()]] - `contains` [EXTRACTED]
- [[test_adapter_does_not_mutate_its_input()]] - `contains` [EXTRACTED]
- [[test_adapter_rejects_missing_required_key()]] - `contains` [EXTRACTED]
- [[test_approaching_goal_fixture_targets_an_existing_object()]] - `contains` [EXTRACTED]
- [[test_bad_ee_pos_length_raises()]] - `contains` [EXTRACTED]
- [[test_bad_object_pose_value_length_raises()]] - `contains` [EXTRACTED]
- [[test_ee_pos_is_coerced_to_float_tuple()]] - `contains` [EXTRACTED]
- [[test_gripper_open_and_closed_variants()]] - `contains` [EXTRACTED]
- [[test_near_wrong_object_state_differs_from_approaching_goal_state()]] - `contains` [EXTRACTED]
- [[test_object_poses_is_real_dict_of_three_tuples_and_target_region_can_be_none()]] - `contains` [EXTRACTED]
- [[test_state_is_immutable()]] - `contains` [EXTRACTED]

#graphify/code #graphify/EXTRACTED #community/Synthetic_State_Fixtures

## 📄 Source

`tests/evasion_tax/metric/test_state.py`
