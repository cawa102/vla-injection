---
source_file: "docs/setup/local-rollout-demo.md"
type: "document"
community: "EET Core Concepts"
tags:
  - graphify/document
  - graphify/EXTRACTED
  - community/EET_Core_Concepts
---

# local-rollout-demo.md

## Connections
- [[Local rollout-recording demo (robosuite stand-in)]] - `defined_in` [EXTRACTED]
- [[robosuite Tier-R local stand-in (honest substitution)]] - `defined_in` [EXTRACTED]

#graphify/document #graphify/EXTRACTED #community/EET_Core_Concepts

## 📄 Source

`docs/setup/local-rollout-demo.md`
