---
source_file: "tests/evasion_tax/attack/test_idealized_frontier.py"
type: "code"
...
# test_idealized_frontier.py

## Connections
- [[AttackResult]] - `references` [EXTRACTED]
- [[Benign +x-ish (goal-directed) rollouts, slightly noisy → small scores.]] - `defined_in` [EXTRACTED]
- [[ConsistencyMetricA]] - `references` [EXTRACTED]
- [[IdealizedActionAttacker]] - `references` [EXTRACTED]
- [[Reach-the-cube scene cube (goal anchor) at +x, distractor at -x.]] - `defined_in` [EXTRACTED]
- [[Scorer]] - `references` [EXTRACTED]
- [[Target action region hold a -x position delta for the whole window.]] - `defined_in` [EXTRACTED]
- [[TargetActionSpec (shared record)]] - `references` [EXTRACTED]
- [[Tests for the idealized action-space attacker + frontier trace (§4b-(II)).  Mech]] - `rationale_for` [EXTRACTED]
- [[_result()]] - `contains` [EXTRACTED]
- [[benign_calib()]] - `contains` [EXTRACTED]
- [[calibrate()]] - `references` [EXTRACTED]
- [[make_attacker()]] - `contains` [EXTRACTED]
- [[make_scenario()_1]] - `contains` [EXTRACTED]
- [[make_scorer()]] - `contains` [EXTRACTED]
- [[make_target()]] - `contains` [EXTRACTED]
- [[records.py]] - `imports_from` [EXTRACTED]
- [[rollout_fires()]] - `references` [EXTRACTED]
- [[test_attack_is_deterministic()]] - `contains` [EXTRACTED]
- [[test_attack_result_is_immutable()]] - `contains` [EXTRACTED]
- [[test_attack_result_rejects_negative_tradeoff()]] - `contains` [EXTRACTED]
- [[test_attack_result_rejects_out_of_range_consistency()]] - `contains` [EXTRACTED]
- [[test_consistency_metric_a_is_a_scorer()]] - `contains` [EXTRACTED]
- [[test_higher_tradeoff_lowers_selected_consistency()]] - `contains` [EXTRACTED]
- [[test_reach_greedy_attacker_reaches_target_with_high_consistency()]] - `contains` [EXTRACTED]
- [[test_reported_reached_is_strict_reached_window()]] - `contains` [EXTRACTED]
- [[test_trace_frontier_benign_fpr_is_conservative()]] - `contains` [EXTRACTED]
- [[test_trace_frontier_excludes_unsupported_scenarios()]] - `contains` [EXTRACTED]
- [[test_trace_frontier_traces_a_downward_sloping_oracle_frontier()]] - `contains` [EXTRACTED]
- [[test_trace_frontier_with_all_excluded_returns_empty_frontier()]] - `contains` [EXTRACTED]
...
`tests/evasion_tax/attack/test_idealized_frontier.py`
...
from evasion_tax.attack.frontier import Frontier
...
from evasion_tax.records import Rollout, TargetActionSpec
