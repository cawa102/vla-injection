---
source_file: "tests/evasion_tax/metric/test_probe_internal.py"
type: "code"
...
# test_probe_internal.py

## Connections
- [[A minimal rollout carrying just what the synthetic extractor keys off.      The]] - `defined_in` [EXTRACTED]
- [[ActivationFeatures_1]] - `references` [EXTRACTED]
- [[InternalProbe_1]] - `references` [EXTRACTED]
- [[RealActivationExtractor]] - `references` [EXTRACTED]
- [[RolloutStep (shared record)]] - `references` [EXTRACTED]
- [[SyntheticActivationExtractor]] - `references` [EXTRACTED]
- [[Tests for the L1 internal-representation probe (playbook §4b-(I)).  The L1 l]] - `rationale_for` [EXTRACTED]
- [[``(features, labels)`` for ``n_per_class`` benign + ``n_per_class`` attacked.]] - `defined_in` [EXTRACTED]
- [[calibrate()]] - `references` [EXTRACTED]
- [[fit_separable_probe()]] - `contains` [EXTRACTED]
- [[labeled_features()]] - `contains` [EXTRACTED]
- [[make_rollout()_1]] - `contains` [EXTRACTED]
- [[records.py]] - `imports_from` [EXTRACTED]
- [[rollout_fires()]] - `references` [EXTRACTED]
- [[test_activation_features_defaults_window_end_to_zero()]] - `contains` [EXTRACTED]
- [[test_activation_features_is_immutable()]] - `contains` [EXTRACTED]
- [[test_activation_features_rejects_empty_delta()]] - `contains` [EXTRACTED]
- [[test_activation_features_rejects_non_finite_delta()]] - `contains` [EXTRACTED]
- [[test_benign_weird_suffix_does_not_fire_at_calibrated_threshold()]] - `contains` [EXTRACTED]
- [[test_calibrates_through_shared_calibrate_and_flags_injection()]] - `contains` [EXTRACTED]
- [[test_fit_rejects_empty_features()]] - `contains` [EXTRACTED]
- [[test_fit_rejects_length_mismatch()]] - `contains` [EXTRACTED]
- [[test_fit_requires_both_classes()]] - `contains` [EXTRACTED]
- [[test_probe_confounds.py]] - `imports_from` [EXTRACTED]
- [[test_probe_is_at_chance_on_pure_noise()]] - `contains` [EXTRACTED]
- [[test_probe_is_immutable()]] - `contains` [EXTRACTED]
- [[test_probe_learns_a_separable_signal_on_heldout_data()]] - `contains` [EXTRACTED]
- [[test_real_extractor_conforms_to_protocol()]] - `contains` [EXTRACTED]
- [[test_real_extractor_is_a_gpu_only_stub()]] - `contains` [EXTRACTED]
- [[test_score_rejects_wrong_feature_dim()]] - `contains` [EXTRACTED]
- [[test_score_returns_unit_interval_score_with_propagated_window_end()]] - `contains` [EXTRACTED]
- [[test_score_rollout_returns_single_decision_score()]] - `contains` [EXTRACTED]
- [[test_synthetic_extractor_conforms_to_protocol()]] - `contains` [EXTRACTED]
- [[test_synthetic_extractor_is_deterministic()]] - `contains` [EXTRACTED]
- [[test_synthetic_extractor_rejects_empty_rollout()]] - `contains` [EXTRACTED]
- [[test_synthetic_extractor_shifts_attacked_features_off_benign()]] - `contains` [EXTRACTED]
- [[test_synthetic_extractor_validates_construction()]] - `contains` [EXTRACTED]

#graphify/code #graphify/EXTRACTED #community/L1_Internal_Probe

## 📄 Source

`tests/evasion_tax/metric/test_probe_internal.py`
