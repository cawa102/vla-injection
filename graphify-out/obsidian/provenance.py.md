---
source_file: "src/evasion_tax/repro/provenance.py"
type: "code"
...
## Connections
- [[Append or update one provenance entry in a JSON manifest.      The manifest is a]] - `defined_in` [EXTRACTED]
- [[Datacheckpoint provenance SHA-256 hashing and a JSON manifest.  Records the so]] - `rationale_for` [EXTRACTED]
- [[Return the hex SHA-256 digest of a file, read in streaming chunks.      Args]] - `defined_in` [EXTRACTED]
- [[StrPath_3]] - `defined_in` [EXTRACTED]
- [[record_provenance]] - `defined_in` [EXTRACTED]
- [[record_provenance()]] - `contains` [EXTRACTED]
- [[sha256_file]] - `defined_in` [EXTRACTED]
...
`src/evasion_tax/repro/provenance.py`
