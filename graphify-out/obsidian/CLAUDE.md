...
## Connections
- [[CLAUDE.md project instructions]] - `defined_in` [EXTRACTED]
- [[Reproducibility non-negotiables]] - `defined_in` [EXTRACTED]
- [[The Five Principles (thinksimplicitysurgicalgoaldocument)]] - `defined_in` [EXTRACTED]
