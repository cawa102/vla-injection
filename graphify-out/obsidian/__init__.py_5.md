---
source_file: "src/evasion_tax/eval/__init__.py"
type: "code"
community: "Evaluation harness + statistics (Task 7)"
location: "L1"
tags:
  - graphify/code
  - graphify/EXTRACTED
  - community/Evaluation_harness__statistics_Task_7
---

# __init__.py

## Connections
- [[Evaluation harness + statistics (Task 7).  The model-free scientific core that p]] - `rationale_for` [EXTRACTED]

#graphify/code #graphify/EXTRACTED #community/Evaluation_harness__statistics_Task_7

## 📄 Source

`src/evasion_tax/eval/__init__.py`
