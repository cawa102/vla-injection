...
## Connections
- [[All per-step scores pooled across rollouts (per-window unit).]] - `defined_in` [EXTRACTED]
- [[An immutable calibrated decision threshold.      Attributes         tau The th]] - `defined_in` [EXTRACTED]
- [[Calibrate ``tau`` to a benign false-abort budget.      Args         benign_scor]] - `defined_in` [EXTRACTED]
- [[FP-calibration of the detector threshold (Task 6).  Chooses ``tau`` on a benign]] - `rationale_for` [EXTRACTED]
- [[Fair-comparison via shared calibrate (plan invariant 4)]] - `defined_in` [EXTRACTED]
- [[One value per rollout its maximum per-step score.]] - `defined_in` [EXTRACTED]
- [[RolloutScores]] - `defined_in` [EXTRACTED]
- [[Threshold_1]] - `contains` [EXTRACTED]
- [[_pooled_steps]] - `defined_in` [EXTRACTED]
- [[_pooled_steps()]] - `contains` [EXTRACTED]
- [[_rollout_maxima]] - `defined_in` [EXTRACTED]
- [[_rollout_maxima()]] - `contains` [EXTRACTED]
- [[calibrate()]] - `contains` [EXTRACTED]
- [[ndarray_4]] - `defined_in` [EXTRACTED]
...
`src/evasion_tax/detector/calibrate.py`
