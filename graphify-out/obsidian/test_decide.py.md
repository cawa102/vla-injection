---
source_file: "tests/evasion_tax/detector/test_decide.py"
type: "code"
...
## Connections
- [[Build an ordered list of Score objects with window_end = start, start+1, ...]] - `defined_in` [EXTRACTED]
- [[Score_8]] - `defined_in` [EXTRACTED]
- [[Tests for the single-step  per-rollout decision logic (Task 6).  Covers strict]] - `rationale_for` [EXTRACTED]
- [[decide()]] - `references` [EXTRACTED]
- [[detection_latency()]] - `references` [EXTRACTED]
- [[records.py]] - `imports_from` [EXTRACTED]
- [[rollout_fires()]] - `references` [EXTRACTED]
- [[scores()]] - `contains` [EXTRACTED]
- [[test_decide_boundary_value_equal_tau_does_not_fire()]] - `contains` [EXTRACTED]
- [[test_decide_does_not_fire_when_value_below_tau()]] - `contains` [EXTRACTED]
- [[test_decide_fires_when_value_strictly_exceeds_tau()]] - `contains` [EXTRACTED]
- [[test_decide_matches_value_gt_tau_exactly_over_a_grid()]] - `contains` [EXTRACTED]
- [[test_detection_latency_none_when_fire_before_onset()]] - `contains` [EXTRACTED]
- [[test_detection_latency_none_when_never_fired()]] - `contains` [EXTRACTED]
- [[test_detection_latency_positive_when_fire_after_onset()]] - `contains` [EXTRACTED]
- [[test_detection_latency_zero_when_fire_at_onset()]] - `contains` [EXTRACTED]
- [[test_rollout_fires_does_not_mutate_input()]] - `contains` [EXTRACTED]
- [[test_rollout_fires_empty_rollout_does_not_fire()]] - `contains` [EXTRACTED]
- [[test_rollout_fires_is_causal_first_not_max()]] - `contains` [EXTRACTED]
- [[test_rollout_fires_no_exceedance_returns_hold_false_step_minus_one()]] - `contains` [EXTRACTED]
- [[test_rollout_fires_returns_first_exceedance_step()]] - `contains` [EXTRACTED]

#graphify/code #graphify/EXTRACTED #community/Detector_Decision_Logic

## 📄 Source

`tests/evasion_tax/detector/test_decide.py`
