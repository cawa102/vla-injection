---
source_file: "tests/evasion_tax/repro/test_env_capture.py"
type: "code"
...
## Connections
- [[SimpleNamespace]] - `defined_in` [EXTRACTED]
- [[Tests for the environment-capture helper.]] - `rationale_for` [EXTRACTED]
- [[_fake_torch()]] - `contains` [EXTRACTED]
- [[_torch_versions()]] - `references` [EXTRACTED]
- [[capture_env()]] - `references` [EXTRACTED]
- [[test_cuda_and_torch_are_none_locally()]] - `contains` [EXTRACTED]
- [[test_dependencies_snapshot_is_present()]] - `contains` [EXTRACTED]
- [[test_driver_version_none_when_cuda_unavailable()]] - `contains` [EXTRACTED]
- [[test_driver_version_resolves_with_mocked_cuda_torch()]] - `contains` [EXTRACTED]
- [[test_git_commit_is_resolved_in_this_repo()]] - `contains` [EXTRACTED]
- [[test_never_raises_on_this_machine()]] - `contains` [EXTRACTED]
- [[test_platform_and_python_version_are_non_empty_strings()]] - `contains` [EXTRACTED]
- [[test_returns_dict_with_required_keys()]] - `contains` [EXTRACTED]

#graphify/code #graphify/EXTRACTED #community/Environment_Capture

## 📄 Source

`tests/evasion_tax/repro/test_env_capture.py`
