---
source_file: "src/evasion_tax/detector/__init__.py"
type: "code"
community: "FP-calibrated detector (Task 6).  Turns "
location: "L1"
tags:
  - graphify/code
  - graphify/EXTRACTED
  - community/FP-calibrated_detector_Task_6__Turns_
---

# __init__.py

## Connections
- [[FP-calibrated detector (Task 6).  Turns per-step consistency scores into a calib]] - `rationale_for` [EXTRACTED]

#graphify/code #graphify/EXTRACTED #community/FP-calibrated_detector_Task_6__Turns_

## 📄 Source

`src/evasion_tax/detector/__init__.py`
