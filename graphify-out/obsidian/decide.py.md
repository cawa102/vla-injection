...
## Connections
- [[Causal holdallow decisions from a calibrated threshold (Task 6).  A consistency]] - `rationale_for` [EXTRACTED]
- [[Decide holdallow for a single step.      Args         score The step's consis]] - `defined_in` [EXTRACTED]
- [[Decision]] - `defined_in` [EXTRACTED]
- [[Return the first-exceedance decision for one ordered rollout.      Scans ``score]] - `defined_in` [EXTRACTED]
- [[Score_4]] - `defined_in` [EXTRACTED]
- [[Steps of deviation before the hold fired, relative to attack onset.      Args]] - `defined_in` [EXTRACTED]
- [[decide()]] - `contains` [EXTRACTED]
- [[detection_latency()]] - `contains` [EXTRACTED]
- [[records.py]] - `imports_from` [EXTRACTED]
- [[rollout_fires()]] - `contains` [EXTRACTED]

#graphify/code #graphify/EXTRACTED #community/Detector_Decision_Logic

## 📄 Source

`src/evasion_tax/detector/decide.py`
