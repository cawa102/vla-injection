---
source_file: "tests/evasion_tax/baselines/test_anomaly.py"
type: "code"
...
## Connections
- [[A benign rollout small zero-mean action deltas (typical LIBERO motion).]] - `defined_in` [EXTRACTED]
- [[A minimal RolloutStep carrying just what the anomaly baseline reads.      The an]] - `defined_in` [EXTRACTED]
- [[BenignActionStats]] - `references` [EXTRACTED]
- [[Tests for the goal-agnostic action-anomaly baseline (Task 8).  This is the man]] - `rationale_for` [EXTRACTED]
- [[benign_rollout()]] - `contains` [EXTRACTED]
- [[benign_stats_from()]] - `contains` [EXTRACTED]
- [[calibrate()]] - `references` [EXTRACTED]
- [[goal_agnostic_anomaly_score()]] - `references` [EXTRACTED]
- [[make_step()]] - `contains` [EXTRACTED]
- [[records.py]] - `imports_from` [EXTRACTED]
- [[rollout_fires()]] - `references` [EXTRACTED]
- [[rollout_from_actions()]] - `contains` [EXTRACTED]
- [[test_action_at_benign_mean_scores_low()]] - `contains` [EXTRACTED]
- [[test_benign_stats_from_rollouts_has_per_dim_mean_and_std()]] - `contains` [EXTRACTED]
- [[test_benign_stats_is_immutable()]] - `contains` [EXTRACTED]
- [[test_benign_stats_rejects_empty_rollouts()]] - `contains` [EXTRACTED]
- [[test_calibrates_through_shared_calibrate_and_flags_attack()]] - `contains` [EXTRACTED]
- [[test_degenerate_benign_with_no_variation_abstains_with_zero_scores()]] - `contains` [EXTRACTED]
- [[test_does_not_mutate_rollout_or_stats()]] - `contains` [EXTRACTED]
- [[test_empty_rollout_returns_no_scores()]] - `contains` [EXTRACTED]
- [[test_out_of_distribution_actions_score_higher_than_benign()]] - `contains` [EXTRACTED]
- [[test_returns_one_score_per_step_in_unit_interval()]] - `contains` [EXTRACTED]
- [[test_score_at_t_is_unaffected_by_future_steps()]] - `contains` [EXTRACTED]
- [[test_score_is_independent_of_trusted_goal_and_target_region()]] - `contains` [EXTRACTED]

#graphify/code #graphify/EXTRACTED #community/Goal-Agnostic_Anomaly_Baseline

## 📄 Source

`tests/evasion_tax/baselines/test_anomaly.py`
