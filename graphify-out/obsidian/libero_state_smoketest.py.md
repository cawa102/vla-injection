---
source_file: "scripts/libero_state_smoketest.py"
type: "code"
community: "LIBERO State Smoketest"
location: "L1"
tags:
  - graphify/code
  - graphify/EXTRACTED
  - community/LIBERO_State_Smoketest
---

# libero_state_smoketest.py

## Connections
- [[Any_2]] - `defined_in` [EXTRACTED]
- [[Best-effort openclosed call from raw gripper joint positions.      Panda's two-]] - `defined_in` [EXTRACTED]
- [[Coerce a length-3 arraysequence to a float triple (positions only).]] - `defined_in` [EXTRACTED]
- [[Load ``PrivilegedState`` directly from its file (decoupled from the evasion_tax]] - `defined_in` [EXTRACTED]
- [[Pull the PrivilegedState-relevant fields out of a robosuiteLIBERO obs dict.]] - `defined_in` [EXTRACTED]
- [[Tier L a real LIBERO task env, state-only. Returns None if LIBERO is absent.]] - `defined_in` [EXTRACTED]
- [[Tier R a state-only robosuite env (LiftPanda). Returns None if robosuite absen]] - `defined_in` [EXTRACTED]
- [[Try to build a real ``PrivilegedState`` from the extracted ground truth.]] - `defined_in` [EXTRACTED]
- [[_as_tuple3()]] - `contains` [EXTRACTED]
- [[_extract_ground_truth()]] - `contains` [EXTRACTED]
- [[_gripper_open_heuristic()]] - `contains` [EXTRACTED]
- [[_load_privileged_state_cls()]] - `contains` [EXTRACTED]
- [[_print_report()_2]] - `contains` [EXTRACTED]
- [[_validate_against_contract()]] - `contains` [EXTRACTED]
- [[main()_6]] - `contains` [EXTRACTED]
- [[try_libero()]] - `contains` [EXTRACTED]
- [[try_robosuite()]] - `contains` [EXTRACTED]

#graphify/code #graphify/EXTRACTED #community/LIBERO_State_Smoketest

## 📄 Source

`scripts/libero_state_smoketest.py`
