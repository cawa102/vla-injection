---
source_file: "docs/plans/codex-hooks-and-cross-layer-eval-plan.md"
type: "document"
...
# codex-hooks-and-cross-layer-eval-plan.md

## Connections
- [[Anti-circularity invariant (no attack-derived constants)]] - `defined_in` [EXTRACTED]
- [[Codex-2 hooks + §4b-III cross-layer eval plan]] - `defined_in` [EXTRACTED]
- [[Coverage manifest (supportedunsupportedabstained)]] - `defined_in` [EXTRACTED]
- [[Cross-layer eval + tax metrics (§4b-III)]] - `defined_in` [EXTRACTED]
- [[Power  sample-size rule (rule-of-three)]] - `defined_in` [EXTRACTED]
- [[ΔASR@fixed-evasion primary tax scalar]] - `defined_in` [EXTRACTED]

#graphify/document #graphify/EXTRACTED #community/GPU_Runbook__Kelvin2

## 📄 Source

`docs/plans/codex-hooks-and-cross-layer-eval-plan.md`
