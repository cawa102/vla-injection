...
## Connections
- [[.__init__()_2]] - `defined_in` [EXTRACTED]
- [[.__post_init__()_7]] - `defined_in` [EXTRACTED]
- [[.extract()]] - `defined_in` [EXTRACTED]
- [[.extract()_2]] - `defined_in` [EXTRACTED]
- [[.extract()_1]] - `defined_in` [EXTRACTED]
- [[.fit()]] - `defined_in` [EXTRACTED]
- [[.score()_1]] - `defined_in` [EXTRACTED]
- [[.score_rollout()_3]] - `defined_in` [EXTRACTED]
- [[A fitted activation-delta logistic-regression probe (higher = more injected).]] - `defined_in` [EXTRACTED]
- [[A fixed unit vector the synthetic injected-class shift points along.]] - `defined_in` [EXTRACTED]
- [[ActivationExtractor]] - `contains` [EXTRACTED]
- [[ActivationExtractor (Protocol seam)]] - `defined_in` [EXTRACTED]
- [[ActivationFeatures_1]] - `contains` [EXTRACTED]
- [[ActivationFeatures_2]] - `defined_in` [EXTRACTED]
- [[Decision-step features for one rollout (immutable; plan invariant 6).      Attr]] - `defined_in` [EXTRACTED]
- [[Deterministic, model-free activation features for local tests (no OpenVLA).]] - `defined_in` [EXTRACTED]
- [[Fit the probe on labelled features (0 = benign, 1 = injected).          Args]] - `defined_in` [EXTRACTED]
- [[InternalProbe_1]] - `contains` [EXTRACTED]
- [[InternalProbe (L1 logistic-regression probe)]] - `defined_in` [EXTRACTED]
- [[L1 internal-representation probe — the activation-delta arm (playbook §4b-(I)).]] - `rationale_for` [EXTRACTED]
- [[One decision score for ``rollout`` (a single-element list, like L0).          Ex]] - `defined_in` [EXTRACTED]
- [[RealActivationExtractor]] - `contains` [EXTRACTED]
- [[RealActivationExtractor (GPU stub)]] - `defined_in` [EXTRACTED]
- [[Return the decision-step activation features for ``rollout``.]] - `defined_in` [EXTRACTED]
- [[Rollout_7]] - `defined_in` [EXTRACTED]
- [[Score_6]] - `defined_in` [EXTRACTED]
- [[Score one rollout's features → injection probability in ``0, 1``.]] - `defined_in` [EXTRACTED]
- [[Seam mapping a rollout to its decision-step class`ActivationFeatures`.      Th]] - `defined_in` [EXTRACTED]
- [[Shared calibrate  invariant 4 (one footing across layers)]] - `defined_in` [EXTRACTED]
- [[Stack features into an ``(n, n_features)`` array, validating each width.]] - `defined_in` [EXTRACTED]
- [[SyntheticActivationExtractor]] - `contains` [EXTRACTED]
- [[SyntheticActivationExtractor_1]] - `defined_in` [EXTRACTED]
- [[The OpenVLA forward-pass backend — deferred to the GPU node (raises here).]] - `defined_in` [EXTRACTED]
- [[_feature_matrix()]] - `contains` [EXTRACTED]
- [[_signal_direction()]] - `contains` [EXTRACTED]
- [[ndarray_6]] - `defined_in` [EXTRACTED]
...
`src/evasion_tax/metric/probe_internal.py`
