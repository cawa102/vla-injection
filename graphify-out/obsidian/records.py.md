...
## Connections
- [[.__len__()]] - `defined_in` [EXTRACTED]
- [[.__post_init__()_10]] - `defined_in` [EXTRACTED]
- [[.__post_init__()_12]] - `defined_in` [EXTRACTED]
- [[.__post_init__()_11]] - `defined_in` [EXTRACTED]
- [[.actions()]] - `defined_in` [EXTRACTED]
- [[.prefix_window()]] - `defined_in` [EXTRACTED]
- [[.reached()]] - `defined_in` [EXTRACTED]
- [[.reached_window()]] - `defined_in` [EXTRACTED]
- [[.reached_window_step()]] - `defined_in` [EXTRACTED]
- [[A causal consistency score; higher = more inconsistent with the goal.      ``val]] - `defined_in` [EXTRACTED]
- [[A holdallow decision emitted by the detector at a given step.]] - `defined_in` [EXTRACTED]
- [[ACTION_DIM]] - `defined_in` [EXTRACTED]
- [[An attacker's target as a low-level action region (decision D2).      The regi]] - `defined_in` [EXTRACTED]
- [[An ordered, immutable sequence of rollout steps.]] - `defined_in` [EXTRACTED]
- [[Coerce any length-7 numeric sequence to a tuple of 7 floats.      Args]] - `defined_in` [EXTRACTED]
- [[Core immutable data records shared across metric  detector  eval (Task 2).  Th]] - `rationale_for` [EXTRACTED]
- [[Decision_1]] - `contains` [EXTRACTED]
- [[Decision (shared record)]] - `defined_in` [EXTRACTED]
- [[Extract a float from a raw score value or a class`Score`.]] - `defined_in` [EXTRACTED]
- [[Index at which the region is first sustained for ``persistence`` steps.]] - `defined_in` [EXTRACTED]
- [[One step of a (benign or attacked) rollout.      ``action`` is coerced to a leng]] - `defined_in` [EXTRACTED]
- [[Return True iff every constrained dim lies within ``low, high``.          Args]] - `defined_in` [EXTRACTED]
- [[Return True iff the region is reached for ``persistence`` consecutive steps.]] - `defined_in` [EXTRACTED]
- [[Return all step actions stacked into an ``(len(steps), 7)`` array.]] - `defined_in` [EXTRACTED]
- [[Return the causal window of steps ``max(0, t-k+1) .. t`` (inclusive).          C]] - `defined_in` [EXTRACTED]
- [[Rollout_8]] - `contains` [EXTRACTED]
- [[Rollout (shared record)]] - `defined_in` [EXTRACTED]
- [[RolloutStep_1]] - `contains` [EXTRACTED]
- [[RolloutStep (shared record)]] - `defined_in` [EXTRACTED]
- [[Score_7]] - `contains` [EXTRACTED]
- [[Score (shared record)]] - `defined_in` [EXTRACTED]
- [[ScoreLike_1]] - `defined_in` [EXTRACTED]
- [[TargetActionSpec_2]] - `contains` [EXTRACTED]
- [[TargetActionSpec (shared record)]] - `defined_in` [EXTRACTED]
- [[_coerce_action()]] - `contains` [EXTRACTED]
- [[anomaly.py]] - `imports_from` [EXTRACTED]
- [[calibrate.py_1]] - `imports_from` [EXTRACTED]
- [[consistency_a.py]] - `imports_from` [EXTRACTED]
- [[cross_layer.py]] - `imports_from` [EXTRACTED]
- [[decide.py]] - `imports_from` [EXTRACTED]
- [[demo_metric_separation.py]] - `imports_from` [EXTRACTED]
- [[demo_rollout.py]] - `imports_from` [EXTRACTED]
- [[dynamics.py]] - `imports_from` [EXTRACTED]
- [[idealized_frontier.py]] - `imports_from` [EXTRACTED]
- [[metrics.py]] - `imports_from` [EXTRACTED]
- [[ndarray_8]] - `defined_in` [EXTRACTED]
- [[perplexity.py]] - `imports_from` [EXTRACTED]
- [[probe_internal.py]] - `imports_from` [EXTRACTED]
- [[score_value()]] - `contains` [EXTRACTED]
- [[test_anomaly.py]] - `imports_from` [EXTRACTED]
- [[test_calibrate.py]] - `imports_from` [EXTRACTED]
- [[test_consistency_a.py]] - `imports_from` [EXTRACTED]
- [[test_cross_layer.py]] - `imports_from` [EXTRACTED]
- [[test_decide.py]] - `imports_from` [EXTRACTED]
- [[test_dynamics.py]] - `imports_from` [EXTRACTED]
- [[test_idealized_frontier.py]] - `imports_from` [EXTRACTED]
- [[test_perplexity.py]] - `imports_from` [EXTRACTED]
- [[test_probe_internal.py]] - `imports_from` [EXTRACTED]
- [[test_records.py]] - `imports_from` [EXTRACTED]
- [[test_state_libero.py]] - `imports_from` [EXTRACTED]

#graphify/code #graphify/EXTRACTED #community/Rollout

## 📄 Source

`src/evasion_tax/records.py`
