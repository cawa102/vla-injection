---
source_file: "docs/plans/2026-06-09-libero-state-adapter.md"
type: "document"
...
# 2026-06-09-libero-state-adapter.md

## Connections
- [[LIBERO State Adapter Implementation Plan]] - `defined_in` [EXTRACTED]
- [[Relative-key (_to_) object-pose extraction filter]] - `defined_in` [EXTRACTED]
- [[srcevasion_taxmetricstate_libero.py (LiberoStateAdapter)]] - `defined_in` [EXTRACTED]
- [[target_region = obj_of_interest-1 convention]] - `defined_in` [EXTRACTED]

#graphify/document #graphify/EXTRACTED #community/LIBERO_State_Adapter_Plan

## 📄 Source

`docs/plans/2026-06-09-libero-state-adapter.md`
