---
source_file: "tests/evasion_tax/metric/test_consistency_a.py"
type: "code"
community: "Metric (A) Tests"
location: "L1"
tags:
  - graphify/code
  - graphify/EXTRACTED
  - community/Metric_A_Tests
---

# test_consistency_a.py

## Connections
- [[A privileged_state dict in the normalised PrivilegedState schema.]] - `defined_in` [EXTRACTED]
- [[ConsistencyMetricA]] - `references` [EXTRACTED]
...
- [[SchemaA]] - `references` [EXTRACTED]
- [[Score (shared record)]] - `references` [EXTRACTED]
- [[Semantics]] - `references` [EXTRACTED]
- [[Tests for consistency metric (A) — frozen schema + causal scorer (Task 5).  Thes]] - `rationale_for` [EXTRACTED]
- [[_anchor()]] - `contains` [EXTRACTED]
- [[_metric()]] - `contains` [EXTRACTED]
- [[_priv()]] - `contains` [EXTRACTED]
- [[_rollout()]] - `contains` [EXTRACTED]
- [[_step()]] - `contains` [EXTRACTED]
- [[records.py]] - `imports_from` [EXTRACTED]
- [[test_combination_max_is_default_and_takes_worst_primitive()]] - `contains` [EXTRACTED]
- [[test_combination_noisy_or_and_mean_match_formulas()]] - `contains` [EXTRACTED]
- [[test_extract_semantics_returns_zeroed_on_unresolved_anchor()]] - `contains` [EXTRACTED]
- [[test_k_controls_how_many_past_steps_inform_the_score()]] - `contains` [EXTRACTED]
- [[test_metric_rejects_bad_k()]] - `contains` [EXTRACTED]
- [[test_monitoring_ceiling_can_see_future_deviation_that_causal_misses()]] - `contains` [EXTRACTED]
- [[test_monitoring_ceiling_is_a_true_upper_bound_on_causal()]] - `contains` [EXTRACTED]
- [[test_monitoring_ceiling_returns_one_score_per_step()]] - `contains` [EXTRACTED]
- [[test_p1_high_when_moving_away_from_goal()]] - `contains` [EXTRACTED]
- [[test_p1_low_when_moving_toward_goal()]] - `contains` [EXTRACTED]
- [[test_p1_zero_when_at_goal_regardless_of_direction()]] - `contains` [EXTRACTED]
- [[test_p1_zero_when_no_motion_and_not_at_goal()]] - `contains` [EXTRACTED]
- [[test_p2_high_when_engaging_distractor_far_from_goal()]] - `contains` [EXTRACTED]
- [[test_p2_zero_when_near_goal()]] - `contains` [EXTRACTED]
- [[test_p2_zero_when_no_distractors()]] - `contains` [EXTRACTED]
- [[test_p3_high_for_grasp_at_distractor()]] - `contains` [EXTRACTED]
- [[test_p3_low_for_grasp_at_goal()]] - `contains` [EXTRACTED]
- [[test_p3_zero_without_a_grasp_event()]] - `contains` [EXTRACTED]
- [[test_resolver_returns_anchor_at_target_region_object()]] - `contains` [EXTRACTED]
- [[test_resolver_unresolvable_returns_none()]] - `contains` [EXTRACTED]
- [[test_schema_and_semantics_and_anchor_are_immutable()]] - `contains` [EXTRACTED]
- [[test_schema_defaults_match_frozen_doc()]] - `contains` [EXTRACTED]
- [[test_schema_rejects_unknown_combination()]] - `contains` [EXTRACTED]
- [[test_score_does_not_warn_when_anchor_resolves()]] - `contains` [EXTRACTED]
- [[test_score_is_causal_future_steps_do_not_change_score_at_t()]] - `contains` [EXTRACTED]
- [[test_score_logs_warning_on_runtime_abstain()]] - `contains` [EXTRACTED]
- [[test_score_returns_valid_score_with_window_end_equal_step_index()]] - `contains` [EXTRACTED]
- [[test_score_rollout_has_one_score_per_step_in_order()]] - `contains` [EXTRACTED]
- [[test_score_uses_exactly_the_causal_window_steps()]] - `contains` [EXTRACTED]
- [[test_state_libero.py]] - `semantically_similar_to` [INFERRED]
- [[test_unresolvable_goal_scores_zero()]] - `contains` [EXTRACTED]

#graphify/code #graphify/EXTRACTED #community/Metric_A_Tests

## 📄 Source

`tests/evasion_tax/metric/test_consistency_a.py`
