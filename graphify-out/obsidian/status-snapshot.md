---
source_file: ".claude/agent-memory/session-context-loader/status-snapshot.md"
type: "document"
...
## Connections
- [[Session status snapshot (model-free track DONE)]] - `defined_in` [EXTRACTED]

#graphify/document #graphify/EXTRACTED #community/Milestones_M0-M3__Branches

## 📄 Source

`.claude/agent-memory/session-context-loader/status-snapshot.md`
